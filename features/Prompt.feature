...
Feature: Deep Agent Search and Task Execution
  ...
  Scenario Outline: Validate database after uploading a file
    ...
    Examples:
      | prompt_user_search                                                                                                                                                                                 | follow_up_query                                                                                                                                                    |
      | build a contract terms extractor. Upload your contract and it will extract key contract terms Ensure the home page displays a drag-and-drop section for uploading contract files (PDF, DOCX, TXT). | no save/export, others you decide |
